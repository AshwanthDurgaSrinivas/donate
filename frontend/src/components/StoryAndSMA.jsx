        ...
        <div className="page-bg">
            ...
            <section className="section-container relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}
                        ...
                        <motion.span variants={fadeUp} className="text-xs font-black uppercase tracking-widest text-primary mb-4 block">The Disease</motion.span>
                        ...
                        <motion.div variants={fadeUp} className="space-y-4 text-white/70 leading-relaxed text-lg">
                            <p>Spinal Muscular Atrophy (SMA) Type 1 is a rare, fatal genetic disease that destroys motor nerve cells. Babies with SMA <strong className="text-white/90">cannot sit, crawl, or swallow</strong> as their muscles waste away.</p>
                            <p>Without treatment, <strong className="text-white/90">most children do not survive beyond age 2</strong>. It is a race against time.</p>
                        </motion.div>
                        <motion.div variants={fadeUp} whileHover={{ scale: 1.02 }}
                            ...
                            <p className="text-white/70 text-base">A one-time gene replacement therapy — the <strong className="text-white/90">world's most expensive medicine</strong> at approx <strong className="gradient-text text-lg">₹1.6 Crore</strong> ($210,000 approx).</p>
                        </motion.div>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="section-container relative overflow-hidden">
                ...
                <div className="text-center mb-16 relative z-10">
                    <motion.span initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-xs font-black uppercase tracking-widest text-accent block mb-3">Our Story</motion.span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                    ...
                    >
                        ...
                        <p className="absolute bottom-4 left-0 right-0 text-center text-sm font-bold text-white/80 italic">Our little star 🌟</p>
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}
                        ...
                        <motion.blockquote variants={fadeRight}
                            className="relative text-lg text-white/70 leading-relaxed italic border-l-4 border-primary/60 pl-6">
                        ...
                        <motion.blockquote variants={fadeRight}
                            className="relative text-lg text-white/70 leading-relaxed italic border-l-4 border-accent/60 pl-6">
                            As middle-class parents, ₹1.6 Crore is a number we can't even dream of. But we <strong className="not-italic text-white/90">can't give up</strong>. Every contribution brings us closer.
                        </motion.blockquote>
